...
void bt832_send(char package1,char package2,char package3,char package4){
    uart_printString("AT+ADVMANU=",No_EOL);
        uart_sendChar(6);
        uart_sendChar(package1);
        uart_sendChar(package2);
        uart_sendChar(0);
        uart_sendChar(package3);
        uart_sendChar(package4);
        uart_sendChar(0);
        uart_receiveString();
}
